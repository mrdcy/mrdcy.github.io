                ...
                return new Promise((function(t) {
                    new Promise((function(t, n) {
                        ...
                        console.log(x), v = x.datum(d).beeswarmChart(), E = d3.selectAll(".model-img"), I = d3.selectAll(".model-circle"), j.node().checked = !0, M(), m.setup({
                            ...
                            if (1 == j.node().checked && g <= _) E.classed("faded", !1), E.classed("highlight", !1), E.classed("is-visible", !1), I.classed("is-visible", !0), "nyongo-button" == this.id && d3.select("#circle-id-S4_Idris_Virgo-01.png").classed("highlight", !0), "hathaway-button" == this.id && d3.select("#circle-id-S4_Idris_Virgo-01.png").classed("highlight", !0), "jones-button" == this.id && d3.select("#circle-id-191_01_2001_0").classed("highlight", !0), "berry-button" == this.id && d3.select("#circle-id-192_12_2002_0").classed("highlight", !0), "kebede-button" == this.id && d3.select("#circle-id-195_05_2005_0").classed("highlight", !0);
                            else if (1 == j.node().checked && g >= _) E.classed("faded", !1), E.classed("highlight", !1), E.classed("is-visible", !1), I.classed("is-visible", !0), "nyongo-button" == this.id && d3.select("#img-id-S4_Idris_Virgo-01.png").classed("highlight", !0), "hathaway-button" == this.id && d3.select("#img-id-S4_Idris_Virgo-01.png").classed("highlight", !0), "jones-button" == this.id && d3.select("#img-id-191_01_2001_0").classed("highlight", !0), "berry-button" == this.id && d3.select("#img-id-192_12_2002_0").classed("highlight", !0), "kebede-button" == this.id && d3.select("#img-id-195_05_2005_0").classed("highlight", !0);
