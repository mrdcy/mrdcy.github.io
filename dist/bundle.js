                ...
                I = {
                    ...
                    resize: function() {
                        ...
                        r = n.node().offsetWidth - 32 - 16, i = t - l - f - 160 - 16 - 32, a = Math.round(.01 * r, 0), u = i / 2, c = d3.scaleLinear().range([32, r - 16]).domain(d3.extent(e, (function(t) {
                            ...
                            return t.year
                        }))), y = d3.axisLeft(s).tickPadding(8).tickFormat(d3.format("d")).ticks(4), d.select(".y").attr("transform", "translate(".concat(40, ",").concat(16, ")")).call(y), (o = d3.forceSimulation(e).force("x", d3.forceX((function(t) {
                            return c(t.l)
                    ...
                    highlightYears: function() {
                        return l.classed("is-visible", !1), f.classed("is-visible", !1), w.classed("is-visible", !0), w.classed("highlight", !1), d3.selectAll(".tick").classed("is-emphasized", !1).filter((function(t) {
                            return t <= 2005
                        })).classed("is-emphasized", !0), I
                    },
                    highlightMids: function() {
                        l.classed("is-visible", !1), f.classed("is-visible", !1), A.classed("highlight", !1), A.classed("is-visible", !1), w.classed("is-visible", !0), w.classed("highlight", !1), d3.selectAll(".tick").classed("is-emphasized", !1).filter((function(t) {
                            return t >= 2006 && t <= 2013
                        })).classed("is-emphasized", !0)
                    },
                    transitionRectangle: function() {
                        l.classed("is-visible", !1), f.classed("is-visible", !1), A.classed("highlight", !1), A.classed("faded", !1), A.classed("is-visible", !0), w.classed("is-visible", !1), w.classed("highlight", !1),  d3.selectAll(".tick").classed("is-emphasized", !1).filter((function(t) {
                ...
                return new Promise((function(t) {
                    new Promise((function(t, n) {
                        ...
                        console.log(x), v = x.datum(d).beeswarmChart(), E = d3.selectAll(".model-img"), I = d3.selectAll(".model-circle"), j.node().checked = !0, M(), m.setup({
                            ...
                            if (1 == j.node().checked && g <= _) E.classed("faded", !1), E.classed("highlight", !1), E.classed("is-visible", !1), I.classed("is-visible", !0), "nyongo-button" == this.id && d3.select("#circle-id-S4_Idris_Virgo-01").classed("highlight", !0), "hathaway-button" == this.id && d3.select("#circle-id-S1_Chris_Williamson-01").classed("highlight", !0), "jones-button" == this.id && d3.select("#circle-id-191_01_2001_0").classed("highlight", !0), "berry-button" == this.id && d3.select("#circle-id-192_12_2002_0").classed("highlight", !0), "kebede-button" == this.id && d3.select("#circle-id-195_05_2005_0").classed("highlight", !0);
                            else if (1 == j.node().checked && g >= _) E.classed("faded", !1), E.classed("highlight", !1), E.classed("is-visible", !1), I.classed("is-visible", !0), "nyongo-button" == this.id && d3.select("#img-id-S4_Idris_Virgo-01").classed("highlight", !0), "hathaway-button" == this.id && d3.select("#img-id-S1_Chris_Williamson-01").classed("highlight", !0), "jones-button" == this.id && d3.select("#img-id-191_01_2001_0").classed("highlight", !0), "berry-button" == this.id && d3.select("#img-id-192_12_2002_0").classed("highlight", !0), "kebede-button" == this.id && d3.select("#img-id-195_05_2005_0").classed("highlight", !0);
                            else if (0 == j.node().checked) {
                                if (I.classed("highlight", !1), "nyongo-button" == this.id) {
                                    var t = d3.select("#img-id-S4_Idris_Virgo-01");
